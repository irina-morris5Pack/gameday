 ...
 * @category Server
 */
export declare type PageRoute<P, Q extends ParsedUrlQuery = ParsedUrlQuery> = (cts: GetServerSidePropsContext<Q>) => Promise<GetServerSidePropsResultWithSession<P>>;
/**
 ...
 * @category Server
 */
export declare type WithPageAuthRequiredOptions<P = any, Q extends ParsedUrlQuery = ParsedUrlQuery> = {
 ...
 * @category Server
 */
export declare type WithPageAuthRequired = <P, Q extends ParsedUrlQuery = ParsedUrlQuery>(opts?: WithPageAuthRequiredOptions<P, Q>) => PageRoute<P, Q>;
/**
 * @ignore
 */
export default function withPageAuthRequiredFactory(loginUrl: string, getSessionCache: () => SessionCache): WithPageAuthRequired;

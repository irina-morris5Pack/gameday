            ...
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, signed_cookies_1.generateCookieValue(key, value, signingKey)];
                    case 2:
                        cookieValue = _f.sent();
                        ...
                        return [4 /*yield*/, signed_cookies_1.generateCookieValue("_" + key, value, signingKey)];
                    case 3:
                        cookieValue = _f.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, signed_cookies_1.getCookieValue(key, cookie, verifyingKeys)];
                    case 2:
                        value = _a.sent();
                        ...
                        return [4 /*yield*/, signed_cookies_1.getCookieValue(fallbackKey, fallbackCookie, verifyingKeys)];
                    case 3:
                        value = _a.sent();
                        _a.label = 4;
                    case 4:

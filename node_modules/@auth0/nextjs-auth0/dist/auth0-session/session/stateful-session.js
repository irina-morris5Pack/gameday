...
var debug = debug_1.default('stateful-session');
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        keys = _a.sent();
                        return [4 /*yield*/, signed_cookies_1.getCookieValue(sessionName, cookies[sessionName], keys)];
                    case 2:
                        sessionId = _a.sent();
                        if (sessionId) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, genId(req)];
                    case 5:
                        sessionId = _b.sent();
                        debug('generated new session id %o', sessionId);
                        return [4 /*yield*/, signed_cookies_1.generateCookieValue(sessionName, sessionId, keys[0])];
                    case 6:
                        cookieValue = _b.sent();

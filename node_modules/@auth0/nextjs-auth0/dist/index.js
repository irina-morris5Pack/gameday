...
function getInstance() {
    instance_check_1.setIsUsingNamedExports();
    if (instance) {
        return instance;
    }
...
var initAuth0 = function (params) {
    instance_check_1.setIsUsingOwnInstance();
    var _a = exports._initAuth(params), sessionCache = _a.sessionCache, publicApi = tslib_1.__rest(_a, ["sessionCache"]); // eslint-disable-line @typescript-eslint/no-unused-vars
    return publicApi;
};
exports.initAuth0 = initAuth0;
var _initAuth = function (params) {
    var _a = config_1.getConfig(tslib_1.__assign(tslib_1.__assign({}, params), { session: tslib_1.__assign({ genId: genId }, params === null || params === void 0 ? void 0 : params.session) })), baseConfig = _a.baseConfig, nextConfig = _a.nextConfig;
    ...
    var updateSession = session_1.updateSessionFactory(sessionCache);
...
var updateSession = function () {
    ...
    return (_a = getInstance()).updateSession.apply(_a, tslib_1.__spread(args));
};

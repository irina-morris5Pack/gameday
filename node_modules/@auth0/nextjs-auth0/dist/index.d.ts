...
import { SessionCache, GetSession, GetAccessToken, Session, AccessTokenRequest, GetAccessTokenResult, Claims, UpdateSession } from './session/';
 ...
 * @category Server
 */
export declare type InitAuth0 = (params?: ConfigParameters) => Auth0Server;
export declare const initAuth0: InitAuth0;
export declare const _initAuth: (params?: import("./auth0-session").DeepPartial<import("./config").BaseConfig & import("./config").NextConfig> | undefined) => Auth0Server & {
...
export { ConfigParameters, HandleAuth, HandleLogin, HandleProfile, HandleLogout, HandleCallback, ProfileOptions, Handlers, GetServerSidePropsResultWithSession, WithPageAuthRequiredOptions, PageRoute, WithApiAuthRequired, WithPageAuthRequired, SessionCache, GetSession, UpdateSession, GetAccessToken, Session, Claims, AccessTokenRequest, GetAccessTokenResult, CallbackOptions, AfterCallback, AfterRefetch, LoginOptions, LogoutOptions, GetLoginState, OnError };
export declare type SessionStore = GenericSessionStore<Session>;
export declare type SessionStorePayload = SessionPayload<Session>;

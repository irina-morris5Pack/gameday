import { CompatibleTypes, FieldKind, FieldRef, InputFieldMap, InterfaceParam, NormalizeArgs, ObjectRef, PluginName, SchemaTypes, ShapeFromTypeParam, TypeParam } from '@pothos/core';
...
export declare class PrismaObjectFieldBuilder<Types extends SchemaTypes, Model extends PrismaModelTypes, NeedsResolve extends boolean, Shape extends object = Model["Shape"]> extends RootBuilder<Types, Shape, "PrismaObject"> {
    ...
    relatedConnection: "relay" extends PluginName ? <Field extends Model["ListRelations"], Nullable extends boolean, Args extends InputFieldMap, ResolveReturnShape, ConnectionInterfaces extends InterfaceParam<Types>[] = [
    ], EdgeInterfaces extends InterfaceParam<Types>[] = [
    ]>(field: Field, options: RelatedConnectionOptions<Types, Model, Field, Nullable, Args, NeedsResolve>, ...args: NormalizeArgs<[
        connectionOptions: PothosSchemaTypes.ConnectionObjectOptions<Types, ObjectRef<Shape>, false, false, ResolveReturnShape, ConnectionInterfaces> | ObjectRef<ShapeFromConnection<PothosSchemaTypes.ConnectionShapeHelper<Types, Shape, false>>>,
        edgeOptions: PothosSchemaTypes.ConnectionEdgeObjectOptions<Types, ObjectRef<Shape>, false, ResolveReturnShape, EdgeInterfaces> | ObjectRef<{
            cursor: string;

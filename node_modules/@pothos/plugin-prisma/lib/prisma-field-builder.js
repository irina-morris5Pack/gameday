/* eslint-disable no-nested-ternary */ /* eslint-disable no-underscore-dangle */ "use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
Object.defineProperty(exports, "PrismaObjectFieldBuilder", {
    enumerable: true,
    get: ()=>PrismaObjectFieldBuilder
});
...
class PrismaObjectFieldBuilder extends RootBuilder {
    ...
    constructor(name, builder, model, fieldMap){
        ...
        this.relatedConnection = function relatedConnection(name, { maxSize , defaultSize , cursor , query , resolve , extensions , totalCount , description , ...options }, connectionOptions = {}, edgeOptions = {}) {
            ...
            const ref = (_options_type = options.type) !== null && _options_type !== void 0 ? _options_type : (0, _datamodel.getRefFromModel)(relationField.type, this.builder);
            let typeName;
            const formatCursor = (0, _cursors.getCursorFormatter)(relationField.type, this.builder, cursor);
            const parseCursor = (0, _cursors.getCursorParser)(relationField.type, this.builder, cursor);
            const getQuery = (args, ctx)=>({
                    ...typeof query === 'function' ? query(args, ctx) : query,
                    ...(0, _cursors.prismaCursorConnectionQuery)({
                        parseCursor,
                        ctx,
                        maxSize,
                        defaultSize,
            ...
            const cursorSelection = _modelLoader.ModelLoader.getCursorSelection(ref, relationField.type, cursor, this.builder);
            ...
            const fieldRef = this.connection({
                ...
                resolve: (parent, args, context)=>{
                    ...
                    return (0, _cursors.wrapConnectionResult)(parent[name], args, connectionQuery.take, formatCursor, (_parent__count = parent._count) === null || _parent__count === void 0 ? void 0 : _parent__count[name]);
                }

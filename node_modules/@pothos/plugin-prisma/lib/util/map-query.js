...
function createStateForType(type, info, parent) {
    ...
    return (0, _selections.createState)(fieldMap, ((_targetType_extensions1 = targetType.extensions) === null || _targetType_extensions1 === void 0 ? void 0 : _targetType_extensions1.pothosPrismaSelect) ? 'select' : 'include', parent);
}

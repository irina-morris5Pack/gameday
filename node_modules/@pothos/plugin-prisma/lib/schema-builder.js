...
schemaBuilderProto.prismaNode = function prismaNode(type, { id: { field , resolve: rawResolve , ...idOptions } , findUnique: rawFindUnique , name , variant , ...options }) {
    var _this, _this_nodeInterfaceRef;
    const fieldName = field;
    const interfaceRef = (_this_nodeInterfaceRef = (_this = this).nodeInterfaceRef) === null || _this_nodeInterfaceRef === void 0 ? void 0 : _this_nodeInterfaceRef.call(_this);
    ...
    this.configStore.onTypeConfig(ref, (nodeConfig)=>{
        ...
        this.objectField(ref, (_this_options_relayOptions_idFieldName = (_this_options_relayOptions = this.options.relayOptions) === null || _this_options_relayOptions === void 0 ? void 0 : _this_options_relayOptions.idFieldName) !== null && _this_options_relayOptions_idFieldName !== void 0 ? _this_options_relayOptions_idFieldName : 'id', (t)=>{
            var _this_options_relayOptions;
            return t.globalID({
                ...(_this_options_relayOptions = this.options.relayOptions) === null || _this_options_relayOptions === void 0 ? void 0 : _this_options_relayOptions.idFieldOptions,
                ...idOptions,
                nullable: false,
                args: {},
...
schemaBuilderProto.prismaObjectField = function prismaObjectField(type, fieldName, field) {
    ...
    this.configStore.onTypeConfig(ref, ({ name  })=>{
        this.configStore.addFields(ref, ()=>({
                [fieldName]: field(new _fieldBuilder.PrismaObjectFieldBuilder(name, this, ref.modelName, (0, _relationMap.getRelationMap)((0, _getClient.getDMMF)(this)).get(ref.modelName)))
            }));
    });
};
schemaBuilderProto.prismaObjectFields = function prismaObjectFields(type, fields) {
    const ref = typeof type === 'string' ? (0, _datamodel.getRefFromModel)(type, this) : type;
    this.configStore.onTypeConfig(ref, ({ name  })=>{
        this.configStore.addFields(ref, ()=>fields(new _fieldBuilder.PrismaObjectFieldBuilder(name, this, ref.modelName, (0, _relationMap.getRelationMap)((0, _getClient.getDMMF)(this)).get(ref.modelName))));
    });
};

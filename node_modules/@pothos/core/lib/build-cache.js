...
class BuildCache {
    ...
    getInputType(ref) {
        ...
        if (type instanceof _graphql.GraphQLObjectType) {
            throw new TypeError(`Expected ${_inputObject.ImplementableInputObjectRef} to be an input type but it was defined as a GraphQLObjectType`);
        }
        if (type instanceof _graphql.GraphQLInterfaceType) {
            throw new TypeError(`Expected ${_inputObject.ImplementableInputObjectRef} to be an input type but it was defined as a GraphQLInterfaceType`);
        }

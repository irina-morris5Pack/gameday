...
export declare const InputListRef: new <Types extends SchemaTypes, T>(name: string, required: boolean) => PothosSchemaTypes.InputListRef<Types, T>;
...
export declare const ListRef: new <Types extends SchemaTypes, T, P = T>(name: string, nullable: boolean) => PothosSchemaTypes.ListRef<Types, T, P>;

import { CompatibleTypes, ExposeNullability, FieldKind, FieldNullability, FieldOptionsFromKind, NormalizeArgs, SchemaTypes, TypeParam } from '../types';
...
export default class FieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends RootFieldBuilder<Types, ParentShape, Kind> {
    ...
    expose<Type extends TypeParam<Types>, Nullable extends FieldNullability<Type>, ResolveReturnShape, Name extends CompatibleTypes<Types, ParentShape, Type, Type extends [unknown] ? {
    ...
    ]>): import("..").FieldRef<import("../types").ShapeFromTypeParam<Types, FieldOptionsFromKind<Types, ParentShape, Type, Nullable, {}, Kind, ParentShape, ResolveReturnShape>["type"], (Nullable & false & (Type extends [unknown] ? ParentShape[Name] extends readonly (infer T)[] | null | undefined ? T extends NonNullable<T> ? ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean | {
        items: boolean;
        list: boolean;
    } : true | {
        items: boolean;
        ...
        items: true;
        list: true;
    } : never : ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean : true)) | (Nullable & true & (Type extends [unknown] ? ParentShape[Name] extends readonly (infer T)[] | null | undefined ? T extends NonNullable<T> ? ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean | {
        items: boolean;
        list: boolean;
    } : true | {
        items: boolean;
        ...
        items: true;
        list: true;
    } : never : ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean : true)) | (Nullable & (Type extends [unknown] ? boolean | {
        items: boolean;
        list: boolean;
    } : boolean) & (Type extends [unknown] ? ParentShape[Name] extends readonly (infer T)[] | null | undefined ? T extends NonNullable<T> ? ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean | {
        items: boolean;
        list: boolean;
    } : true | {
        items: boolean;
        ...
        items: true;
        list: true;
    } : never : ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean : true))>, Kind>;
}

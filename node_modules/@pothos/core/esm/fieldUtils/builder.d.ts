...
export default class FieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends RootFieldBuilder<Types, ParentShape, Kind> {
    ...
    expose<Type extends TypeParam<Types>, Nullable extends FieldNullability<Type>, ResolveReturnShape, Name extends CompatibleTypes<Types, ParentShape, Type, Type extends [
        ...
        items: true;
        list: true;
    } : never : ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean : true)) | (Nullable & true & (Type extends [
        unknown
    ] ? ParentShape[Name] extends readonly (infer T)[] | null | undefined ? T extends NonNullable<T> ? ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean | {
        items: boolean;
        list: boolean;
        ...
        items: true;
        list: true;
    } : never : ParentShape[Name] extends NonNullable<ParentShape[Name]> ? boolean : true)) | (Nullable & (Type extends [
        unknown
    ] ? boolean | {
        items: boolean;
        list: boolean;
